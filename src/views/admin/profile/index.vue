<template>
	<div class="flex flex-col gap-5 lg:flex-row lg:justify-around pt-10 px-10">
		<BaseCard class="flex flex-col gap-7 items-center lg:w-2/5">
			...
			>
				<font-awesome-icon class="text-[70pt]" :icon="['fas', 'user']" />
			</div>
		...
		<BaseCard class="lg:w-3/5">
			...
			<div class="flex flex-col gap-5 items-center lg:flex-row lg:justify-end">
				<v-btn
					color="#7e81ee"
