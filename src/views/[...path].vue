			...
			>
				<div class="w-full md:w-1/2">
					...
					<div class="mb-10 md:mb-20 text-gray-600 font-light">
						<h1
							class="font-black uppercase text-3xl lg:text-6xl text-brand mb-10"
						>
							You seem to be lost!
						</h1>
						<p class="text-xl">
					...
					<div class="mb-20 md:mb-0">
						<router-link
							to="/"
							class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-brand hover:text-yellow-600"
						>
